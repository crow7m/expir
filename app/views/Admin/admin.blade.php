...
<script type="text/javascript" src="expir/public/tinymce/js/tinymce/tinymce.min.js"></script>
<script>
tinymce.init({
    selector: "textarea",
    theme: "modern",
...
<li class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-user">
        ...
        <li class="divider"></li>
        <li><a  href="{{URL::action('Logout')}}"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
        </li>
    </ul>
    <!-- /.dropdown-user -->
</li>
        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{action('NewsController@getNews')}}">News Page</a>
